...
class GeneralUnifyTest extends AbstractUnifyTest
{
    ...
    {
        $this->assertEquals(null, $this->unify(null, null));

        $this->assertEquals($this->createInteger(), $this->unify($this->createInteger(), $this->createInteger()));
    }

    public function testSymmetry(): void
    {
        $this->assertEquals($this->createInteger(), $this->unify($this->createInteger(), null));
        $this->assertEquals($this->createInteger(), $this->unify(null, $this->createInteger()));
    }
    ...
    public function testIncompatibleTypes(): void
    {
        ...
        $this->unify($this->createMixed(), $this->createInteger(false));
    }
    ...
    public function testIncompatibleNullableTypes(): void
    {
        ...
        $this->assertEquals(
            ...
            $this->unify($this->createInteger(true), $this->createInteger(false))
        );
    }
}
