...
class ClassPropertyTypeTest extends AbstractPropertyTest
{
    ...
    {
        $this->assertPropertyTypeVariableType('class', $this->createClass(PropertyTypeReader::class));
        $this->assertPhpDocVariableType('class', $this->createClass(PropertyTypeReader::class));
    }

    public function testInterfaceType(): void
    {
        $this->assertPropertyTypeVariableType('interface', $this->createClass(DateTimeInterface::class));
        $this->assertPhpDocVariableType('interface', $this->createClass(DateTimeInterface::class));
    }
